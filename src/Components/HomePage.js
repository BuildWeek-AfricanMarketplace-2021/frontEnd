    ...
    <div className="landing is-preload">
      ...
      <div id="page-wrapper">
        ...
        <section id="banner">
          <div className="inner">
            ...
            <ul className="actions special">
              <li>
                <a href="activate" className="button primary">
                  Activate
                </a>
              </li>
            </ul>
        ...
        <section id="cta" className="wrapper style4">
          <div className="inner">
            ...
            <ul className="actions stacked">
              <li>
                <a href="activate" className="button fit primary">
                  Activate
                </a>
              </li>
              <li>
                <a href="activate" className="button fit">
                  Learn More
                </a>
              </li>
            </ul>
        ...
        <footer id="footer">
          <ul className="icons">
            <li>
              <a href="footer" className="icon brands fa-twitter">
                <span className="label">Twitter</span>
              </a>
            </li>
            <li>
              <a href="footer" className="icon brands fa-facebook-f">
                <span className="label">Facebook</span>
              </a>
            </li>
            <li>
              <a href="footer" className="icon brands fa-instagram">
                <span className="label">Instagram</span>
              </a>
            </li>
            <li>
              <a href="footer" className="icon brands fa-dribbble">
                <span className="label">Dribbble</span>
              </a>
            </li>
            <li>
              <a href="footer" className="icon solid fa-envelope">
